...
export const BrandForm: React.FC<BrandFormProps> = ({
  ...
  const onSubmit = async (data: SubCategoryFormValues) => {
    try{
      setLoading(true)
      if(initialData){
        await axios.patch(`/api/${params.storeId}/brands/${params.brandId}`, data).then(() => router.push(`/${params.storeId}/brands`))
      }else{
        await axios.post(`/api/${params.storeId}/brands`, data).then(() => router.push(`/${params.storeId}/brands`))
      }
